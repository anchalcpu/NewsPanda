...
export default class News extends Component {
    ...
    async componentDidMount(){
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&pageSize=${this.props.pageSize}&apiKey=${this.props.apiKey}&category=${this.props.category}`;
    ...
    return (
      <div className="container py-5 px-5">
        ...
        <div className="d-flex justify-content-between">
            ...
            <Weather key="weather" weather_key={this.props.weather_key}/>
            </div>
